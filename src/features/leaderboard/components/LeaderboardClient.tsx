  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
      <section className="relative overflow-hidden py-2">
        <div className="pointer-events-none absolute inset-x-0 top-0 h-48 bg-[radial-gradient(circle_at_top,rgba(37,99,235,0.16),transparent_58%)]" />
        <div className="relative flex flex-col gap-4">
          <div className="flex items-start gap-5">
            <div className="flex h-24 w-24 shrink-0 items-center justify-center rounded-[28px] border border-cyan-300/20 bg-[linear-gradient(180deg,rgba(30,64,175,0.22),rgba(17,24,39,0.66))] text-cyan-100 shadow-[0_0_40px_rgba(56,189,248,0.14)]">
              <Trophy className="h-10 w-10" />
            </div>
            <div>
              <p className="surface-label text-cyan-200/80">{t("leaderboard.label")}</p>
              <h1 className="mt-3 font-[var(--font-sora)] text-3xl font-extrabold text-white sm:text-5xl">{t("leaderboard.title")}</h1>
        ...
        <div className="relative mt-6 overflow-hidden rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.78),rgba(17,24,39,0.58))] shadow-[0_18px_50px_rgba(2,6,23,0.22)]">
        ...
        <div className="relative mt-3 rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.68),rgba(17,24,39,0.48))] p-5 shadow-[0_14px_40px_rgba(2,6,23,0.16)]">
      ...
      <section className="mt-6 overflow-hidden rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,13,33,0.96),rgba(11,18,40,0.92))] shadow-[0_18px_55px_rgba(2,6,23,0.28)]">
        ...
        <div className="m-5 overflow-x-auto rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,16,36,0.96),rgba(6,12,28,0.94))] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
          <table className="w-full min-w-[760px] border-collapse">
            <thead>
              <tr className="border-b border-white/10 bg-white/[0.03] text-xs font-black uppercase tracking-[0.14em] text-slate-400">
                ...
                entries.map((entry) => (
                  <tr
                    className={`h-16 border-b border-white/10 last:border-b-0 transition duration-150 ${
                      entry.rank === 1
                        ? "bg-[linear-gradient(90deg,rgba(252,211,77,0.08),rgba(255,255,255,0))] hover:bg-[linear-gradient(90deg,rgba(252,211,77,0.12),rgba(255,255,255,0.02))]"
                        : entry.rank === 2
                          ? "bg-[linear-gradient(90deg,rgba(226,232,240,0.05),rgba(255,255,255,0))] hover:bg-[linear-gradient(90deg,rgba(226,232,240,0.08),rgba(255,255,255,0.02))]"
                          : entry.rank === 3
                            ? "bg-[linear-gradient(90deg,rgba(251,146,60,0.06),rgba(255,255,255,0))] hover:bg-[linear-gradient(90deg,rgba(251,146,60,0.1),rgba(255,255,255,0.02))]"
                            : "hover:bg-white/[0.03]"
                    }`}
                    key={entry.user_id}
                  >
                    ...
                    <td className="px-4 py-3 align-middle">
                      <div className="flex min-w-0 items-center gap-2">
                        ...
                        <span className="min-w-0 truncate text-base font-extrabold text-white">{entry.display_name || t("leaderboard.anonymous")}</span>
                        {entry.rank <= 3 ? (
...
function SummaryStripItem({
  ...
  return (
    <div className="bg-[linear-gradient(180deg,rgba(15,23,42,0.8),rgba(15,23,42,0.55))] px-5 py-5">
